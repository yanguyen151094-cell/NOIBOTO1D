...
const NAV_ITEMS: NavItem[] = [
  ...
  { to: "/movies", label: "Rạp chiếu phim", icon: "ri-movie-line" },
  ...
  { to: "/rewards", label: "Nhận thưởng", icon: "ri-coin-line" },
  ...
  { to: "/staff-ranking", label: "Bảng xếp hạng", icon: "ri-trophy-line" },
  { to: "/team-stats", label: "Số liệu tổ", icon: "ri-bar-chart-box-line", adminOnly: true },
